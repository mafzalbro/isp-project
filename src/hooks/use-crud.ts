...
export function useCrud<T extends { id: string, name: string }>({
    ...
    useEffect(() => {
        try {
            ...
            console.error(`Failed to load or parse ${entityNamePlural} from localStorage`, error);
            setData(mockData);
        }
    ...
    const handleSubmit = useCallback(() => {
        ...
        closeDialog();
    }, [data, itemToEdit, formData, closeDialog, toast, entityName, storageKey, readOnly]);
